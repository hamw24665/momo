...
if [ ! -f ./Run ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "Run IS NOT FIND IN FILES BOT"
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./Run -s ./MODEDEV.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
local Name = '['..utf8.sub(data.first_name_,0,40)..'](Run://user?id='..data.id_..')'
if type == 'kick' then 
...
local Name = '['..string.sub(ta.first_name_,0, 40)..'](Run://user?id='..ta.id_..')'
...
if text == 'حظر' then
local Name = '['..string.sub(data.first_name_,0, 40)..'](Run://user?id='..id_user..')'
...
sendText(msg.chat_id_,'\n•بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](Run://user?id='..result.id_..')\n• تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](Run://user?id='..result.id_..')'
...
tagname = tagname:gsub("[[]","")
t = t..", ["..tagname.."](Run://user?id="..v.user_id_..")"
if x == 5 or x == tags or k == 0 then
...
tagname = tagname:gsub("]","")
tagname = tagname:gsub("[[]","")
t = t.."*︙"..x.."︙l>* {["..tagname.."](Run://user?id="..v.user_id_..")} \n"
end
if k == 0 then
send(msg.chat_id_,msg.id_,t)
end
